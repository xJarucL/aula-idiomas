        ...
        <div class="w-full max-w-xs sm:max-w-sm md:max-w-md">
            ...
            <a href="{{ route('google.login') }}"
                ...
                <svg class="w-5 h-5 mr-2" viewBox="0 0 533.5 544.3">
                    <path d="M533.5 278.4c0-17.4-1.5-34.1-4.3-50.4H272v95.4h147.5c-6.4 34.5-25.8 63.7-55 83.2v68h88.8c51.8-47.7 80.2-118 80.2-196.2z" fill="#4285F4"/>
                    <path d="M272 544.3c74.7 0 137.4-24.7 183.2-66.9l-88.8-68c-24.7 16.5-56.4 26.3-94.4 26.3-72.7 0-134.2-49-156.2-114.8h-91.6v71.8C70.1 482 163.7 544.3 272 544.3z" fill="#34A853"/>
                    <path d="M115.8 320.9c-5.6-16.5-8.8-34.3-8.8-52.4s3.2-35.9 8.8-52.4v-71.8h-91.6C7.7 183.3 0 227.6 0 268.5s7.7 85.2 24.2 124.2l91.6-71.8z" fill="#FBBC05"/>
                    <path d="M272 107.7c40.6 0 77 13.9 105.7 41.1l79.1-79.1C409.4 24.7 346.7 0 272 0 163.7 0 70.1 62.3 24.2 159.1l91.6 71.8c22-65.8 83.5-114.8 156.2-114.8z" fill="#EA4335"/>
                </svg>
