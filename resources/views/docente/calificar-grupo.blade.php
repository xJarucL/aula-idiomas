...
<style>
    ...
    .sb-success { background: linear-gradient(135deg, #00897B, #086960ff); }
    .sb-error   { background: linear-gradient(135deg, #dc2626, #b61313ff); }
            ...
            <table class="min-w-full divide-y divide-gray-200 text-sm">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left font-semibold text-gray-700 uppercase tracking-wider hidden sm:table-cell">
                            Calificación
                        </th>
