...
<div class="h-150 sm:h-[35rem] overflow-auto pr-2">
    ...
    <div class="flex flex-col gap-2 mb-6">
        ...
        <p class="text-gray-400 text-sm sm:text-lg">Selecciona un grupo para ver detalles o calificar.</p>
    </div>
                ...
                <div class="bg-white shadow-md hover:shadow-xl transition
                    ...
                    <div class="flex justify-between items-start mb-3">
                        ...
                        <a href="{{ route('docente.detalle-grupo', $grupo->grupo->pk_grupo) }}"
                            ...
                            <svg class="w-8 h-8 sm:w-10 sm:h-10 text-teal-600" fill="none" stroke="currentColor" stroke-width="2"
                                viewBox="0 0 24 24">
