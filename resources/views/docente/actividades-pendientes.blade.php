...
@section('content')
    ...
    <section class="sm:mx-6 mt-3.5 sm:mt-6">
        <div class="bg-white shadow-lg rounded-2xl p-4">
            <h2 class="text-2xl sm:text-4xl font-semibold text-teal-600 mb-4">Entregas pendientes de revisión</h2>

            <div class="flex flex-col sm:flex-row sm:items-center sm:gap-4 mb-4">
                <div class="flex justify-between gap-2 w-full mb-2 sm:mb-0">
                    <div class="relative w-full">
                        <input id="buscador" data-url="{{ route('docente.pendientes.filtrar') }}"
                            ...
                            type="text" placeholder="Buscar por alumno o actividad...">
                ...
                <select id="filtro-grupo" name="grupo" data-filter="true"
                    class="bg-white text-gray-600 border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-teal-500 shadow text-sm md:text-base w-full sm:w-1/4">
