...
<section class="flex-1 flex flex-col md:flex-row justify-between m-2 gap-2">
    <div>
        <h1 class="text-2xl md:text-4xl font-bold text-black">Mis Grupos</h1>
        <span class="text-gray-500 font-light mt-2 block">
...
<section class="flex flex-col md:flex-row justify-between mt-5 gap-5">
    <div class="relative w-full">
        <input
            id="buscador"
            data-url="{{ route('docente.mis-grupos') }}"
    ...
    <select name="fk_carrera" data-filter
        class="bg-white border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-teal-500 shadow text-sm md:text-base w-full md:w-50">
    ...
    <select name="fk_cuatrimestre" data-filter
        class="bg-white border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-teal-500 shadow text-sm md:text-base w-full md:w-auto">
