...
@section('content')
    ...
    <div class="max-w-4xl mx-auto mt-2 bg-white rounded-lg shadow p-8">
        ...
        <section class="flex flex-col items-center text-center mb-8">
            ...
            <h2 class="text-2xl font-semibold">Jaruny Guadalupe Cárdenas Tirado</h2>
            ...
            <a 
                ...
                href="{{ route('docente.editar-perfil') }}">Editar perfil
            </a>
        </section>
        ...
        <section class="pt-5 mb-6">
            ...
            <div class="flex justify-start border-b border-gray-200 pb-4 mb-4">
                ...
                <span class="text-gray-600">jarunyct@gmail.com</span>
            </div>
        </section>
        {{-- cargo --}}
        <section class="mt-15">
