    ...
    <div class="flex justify-center mt-10 px-2 md:px-0">
        <div class="w-full max-w-3xl">
            ...
            <div class="flex flex-row items-center w-full gap-2 mb-3 sm:mb-6">
                ...
                <div class="flex justify-center items-center w-ful">
            ...
            <form id="form-insertar" data-url="{{ route('docente.asignando-actividad', $actividad->pk_actividad) }}"
                ...
                <div class="bg-white rounded-2xl shadow-2xs border border-gray-300 p-6 space-y-6">
                    ...
                    <div class="flex flex-col sm:flex-row md:items-center w-full gap-2">
                        <label class="text-gray-600 text-[17px] font-light">Fecha de entrega</label>
                        <input type="date" name="fecha_entrega"
                            class="p-2 w-full text-gray-600 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 transition"
                            required>
                    </div>

                    <div>
                        <h3 class="text-gray-600 text-[18px] font-semibold mb-2 text-center md:text-left">Seleccione los
                            grupos</h3>
                    ...
                    <div>
                        <h3 class="text-gray-600 text-[18px] font-semibold mb-2 text-center md:text-left">Grupos asignados
                        </h3>
                        <div id="asignadosContainer"
                            class="flex flex-wrap justify-center md:justify-start gap-3 min-h-[60px] border border-gray-200 rounded-lg p-3 bg-gray-50">
