    ...
    <table class="min-w-full text-xs md:text-base">
        <thead class="sticky top-0">
            <tr class="hidden sm:table-row bg-teal-50">
                <th class="py-2 px-2 md:px-4 text-left text-teal-800">NOMBRE COMPLETO</th>
                <th class="py-2 px-2 md:px-4 text-left text-teal-800">CORREO</th>
                <th class="py-2 px-2 md:px-4 text-left text-teal-800">PERMISO</th>
