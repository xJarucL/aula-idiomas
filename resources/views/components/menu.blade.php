            ...
            <div class="flex items-center gap-4">
               ...
               <div x-data="{ open: false }" class="relative">
                ...
                <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-40 bg-white rounded-sm shadow-lg z-50">
                    <a href="#" class="block px-4 py-2 text-gray-700 hover:bg-teal-100 rounded-b-sm">Perfil</a>
                    <form class="" method="POST" action="">
                        @csrf
                        <button type="submit" class="w-full text-left px-4 py-2 text-gray-700 hover:bg-red-500 hover:text-white rounded-b-sm cursor-pointer">Cerrar sesión</button>
                    </form>
                </div>
            </div>
        </div>
