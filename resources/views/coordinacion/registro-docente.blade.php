...
<section class="flex-1 flex justify-center items-center mt-10">
    ...
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-3xl">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{route('coordinacion.lista-docente')}}" class="bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-700 shadow">
                Cancelar
            </a>
        </div>
        <form id="form-insertar" data-url="{{ route('coordinacion.guardar-docente') }}" class="w-full gap-6" action="" method="post">
            @csrf
