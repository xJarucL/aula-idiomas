...
@section('title', 'Coordinación - Editar perfil')
...
<div class="max-w-4xl mx-auto mt-6 bg-white rounded-lg shadow p-8" x-data="perfil()">
    ...
    <form id="form-insertar" data-url="{{ route('coordinador.actualizar-perfil') }}" class="w-full gap-6" action="" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
