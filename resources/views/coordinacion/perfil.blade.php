...
@section('content')
    ...
    <div class="max-w-4xl mx-auto mt-2 bg-white rounded-lg shadow p-8">
        ...
        <section class="flex flex-col items-center text-center mb-8">
            ...
            <img class="w-28 h-28 border border-l-gray-500 rounded-full mb-4" src="{{ asset('img/default.jpg') }}" alt="foto de perfil">
            <h2 class="text-2xl font-semibold">María Guadalupe Cardenas Laz</h2>
            ...
            <a 
                ...
                href="{{ route('coordinacion.editar-perfil') }}">Editar perfil
            </a>
        </section>
        ...
        <section class="pt-5 mb-6">
            ...
            <div class="flex justify-start border-b border-gray-200 pb-4 mb-4">
                ...
                <span class="text-gray-600">mariagl@gmail.com</span>
            </div>
        </section>
        {{-- cargo --}}
        <section class="mt-15">
            ...
            <div class="flex flex-col md:flex-row justify-around gap-4">
                ...
                <div class="bg-gray-100 rounded-lg p-4 mb-2 w-3xs text-start shadow">
                    <p class="text-gray-600">Estudiante registrados</p>
