...
@section('content')
    ...
    <section class="flex-1 flex justify-center items-center mt-8 sm:mt-12">
        <x-msj-alert />
        <div class="bg-white p-3 sm:p-8 rounded-lg shadow-md w-full max-w-3xl">
            <div class="flex w-full items-center mb-6">
                <div class="flex flex-row items-center w-full gap-2">
                    <a href="{{route('coordinacion.lista-grupos')}}" class="w-auto flex justify-center items-center">
                    ...
                    <div class="flex justify-start sm:justify-center items-center w-full">
                        <h1 class="text-3xl sm:text-5xl font-bold text-teal-600">Crea un Grupo</h1>
                    </div>
            ...
            <form id="form-insertar" data-url="{{ route('coordinacion.guardar-grupo') }}" class="w-full gap-6"
                action="" method="post">
                @csrf
                <div class="flex flex-col gap-2">
                    ...
                    <input
                        class="p-2 border border-gray-300 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-teal-500 focus-border-transparent transition"
                        type="text" name="año" required maxlength="4"
