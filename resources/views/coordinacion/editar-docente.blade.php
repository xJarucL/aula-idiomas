...
<div class="max-w-4xl mx-auto mt-6 bg-white rounded-lg shadow p-8">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <span class="text-gray-500 font-light pt-2 block">{{$docente->nombres}} {{$docente->ap_paterno}} {{$docente->ap_materno ?? ''}}</span>
        </div>
    ...
    <form id="form-insertar" data-url="{{ route('docente.actualizar-correo') }}" class="w-full gap-6" action="" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="flex flex-col gap-2">
            ...
            <input
                ...
                type="email" name="email" value="{{ $docente->email }}" required
            >

            <input type="hidden" name="pk_usuario" value="{{$docente->pk_usuario}}">
