...
@section('title', 'Lista de alumno | Aula de Idiomas')
...
@section('content')
    ...
    <section class="flex sm:flex-row justify-between gap-6 sm:gap-2">
        ...
        <div class="hidden sm:flex items-center justify-center">
            <a href="{{ route('coordinacion.registro-alumno') }}"
                class="bg-teal-600 text-white m-3 p-2 rounded-lg hover:bg-teal-700 shadow text-sm md:text-base">Registrar
                alumno
            </a>
        </div>
        {{-- MOVIL --}}
        <div class="sm:hidden flex items-center justify-center">
            <a href="{{ route('coordinacion.registro-alumno') }}" class="bg-teal-600 p-3 rounded-lg hover:bg-teal-700 shadow">
        ...
        <div class="flex justify-between gap-2 w-full">
            <div class="relative w-full">
                <input id="buscador"
                    ...
                    type="text" placeholder="Buscar..." value="{{ request('search') }}">
            ...
            <button id="btn-buscar"
                class="bg-teal-600 text-white px-4 py-2 rounded-lg hover:bg-teal-700 shadow text-sm md:text-base">
                Buscar
            </button>
        </div>
        <div class="flex gap-2 w-full md:w-1/3">
            <select name="promedio" data-filter
