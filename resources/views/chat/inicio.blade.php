    ...
    <div class="flex flex-row h-full">
        ...
        <section class="w-4/5">
            ...
            @else
                ...
                <div>
                    <form id="formMensaje" class="flex flex-row items-center gap-3 p-3 border-t border-gray-300">
                        ...
                        <button type="submit" class="bg-teal-700 p-2 text-white rounded-lg hover:bg-teal-800 shadow">
                            Enviar
                        </button>
                    </form>
                </div>
